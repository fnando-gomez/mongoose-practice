...
mongoose.connect("mongodb://localhost/mongoose-practice", {useNewUrlParse: true, useFindAndModify:false},() => console.log("I'm alive"))
...
//   return getRandIntBetween(45, 120)
// }
// var getHeight = function() {
//   return getRandIntBetween(150, 200)
// }
// var getSalary = function() {
//   return getRandIntBetween(20000, 75000)
// }
...
// 	console.log(`The books with 200 < pages < 500 are: ${books} `)
// })

// // General searching of books --> 
...
// Book.find({rating:{"$lt":4}}).sort({author:1}).exec(function(err, books){
//   console.log(`The books that you are looking are: ${books}`)
// })
...
// Person.find(({ height:{"$gt":180}, salary:{"$gt":30000}}), function(err, persons)
// {
//   console.log(persons)
// })

//2. Find all the people who are tall (>180) OR rich (>30000)
// Person.find({$or:[{height:{"$gt":180}}, {salary:{"$gt":30000}}]},function(err, persons){
//   console.log(persons)
// })
